...
type SortOrder = SortOrder
    with 
        ...
        static member orderBy (x : Datatype) = SortOrder.orderBy x.Schema, x.Name 
        static member orderBy (x : TableType) = SortOrder.orderBy x.Schema, x.Name 
        static member orderBy (x : Procedure) = SortOrder.orderBy x.Object.Schema, x.Name 
