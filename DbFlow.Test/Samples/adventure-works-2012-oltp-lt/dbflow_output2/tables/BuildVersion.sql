...
EXECUTE [sys].[sp_addextendedproperty] N'MS_Description', N'Current version number of the AdventureWorksLT 2012 sample database. ', N'SCHEMA', [dbo], N'TABLE', [BuildVersion];
